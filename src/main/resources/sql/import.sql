...
(1, 1, 'Java 중간고사', 'Java 기초 및 객체지향 개념 평가', '2025-06-18 8:00:00', '2025-06-19 12:00:00', 'IN_PROGRESS'),
...
-- ALTER TABLE question ALTER COLUMN id RESTART WITH 13;
-- ALTER TABLE question_choices ALTER COLUMN id RESTART WITH 1;
