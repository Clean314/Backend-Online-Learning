...
INSERT INTO lecture_history (
    student_id, lecture_id, attendance, watched_time, created_at, updated_at) VALUES
    (1, 1, FALSE, 64.8,  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 2, TRUE, 152.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 3, TRUE, 40.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 4, FALSE, 387.5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 5, TRUE, 298.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 6, TRUE, 564.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 7, TRUE, 79.1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 8, FALSE, 142.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 9, FALSE, 217.6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 10, TRUE, 593.5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 11, TRUE, 113.2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 12, TRUE, 573.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 1, TRUE, 609.9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 2, TRUE, 99.2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 3, FALSE, 288.1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 4, FALSE, 663.9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 5, TRUE, 556.9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 6, TRUE, 459.5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 7, FALSE, 166.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 8, FALSE, 527.5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 9, TRUE, 496.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 10, FALSE, 336.4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 11, TRUE, 187.9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (2, 12, TRUE, 83.1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 1, FALSE, 517.7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 2, TRUE, 129.6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 3, FALSE, 77.8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 4, FALSE, 410.5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 5, FALSE, 125.8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 6, TRUE, 244.0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 7, FALSE, 518.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 8, TRUE, 474.3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 9, TRUE, 240.4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 10, FALSE, 263.2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 11, TRUE, 242.8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (6, 12, TRUE, 228.1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);